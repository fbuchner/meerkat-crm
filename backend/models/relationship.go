...
type Relationship struct {
	...
	Name             string   `json:"name" validate:"required,min=1,max=100"`                                // Name of the related person
	Type             string   `json:"type" validate:"required,min=1,max=50"`                                 // Relationship type (e.g., "Child", "Mother")
	Gender           string   `json:"gender" validate:"omitempty,max=50"`                                    // Gender of the related person
